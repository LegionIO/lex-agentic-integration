...
RSpec.describe Legion::Extensions::Agentic::Integration::Zeitgeist::Runners::CognitiveZeitgeist do
  let(:client) { Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::Client.new }
  let(:engine) { Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::ZeitgeistEngine.new }
