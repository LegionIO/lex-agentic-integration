...
RSpec.describe Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::ZeitgeistEngine do
  ...
  describe '#ingest' do
    it 'returns a CognitiveSignal' do
      signal = ingest
      expect(signal).to be_a(Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::CognitiveSignal)
    end
    ...
    it 'caps signals at MAX_SIGNALS' do
      stub_const('Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::Constants::MAX_SIGNALS', 3)
      4.times { ingest }
      expect(engine.signals.size).to eq(3)
    end
  end
  ...
  describe '#rising_domains' do
    ...
    it 'identifies rising domains' do
      constants = Legion::Extensions::Agentic::Integration::Zeitgeist::Helpers::Constants
